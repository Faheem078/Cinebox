...
import CreditSeriesApi from '../components/CreditSeriesApi';
import SimilerSeriesApi from '../components/SimilerSeriesApi';
...
export default function SeriesDetails() {
    ...
    const fetchApi = async () => {
        try {
           const response = await fetch(`https://api.themoviedb.org/3/tv/${id}?api_key=4e7783a6a3bf804ec4011f13935e14b8`);
           const data = await response.json();
           setProducts(data);

           // Fetch trailers
           const videosRes = await fetch(`https://api.themoviedb.org/3/tv/${id}/videos?api_key=4e7783a6a3bf804ec4011f13935e14b8`);
