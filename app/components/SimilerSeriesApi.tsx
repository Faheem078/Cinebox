...
export default function SimilerSeriesApi() {
  ...
  const fetchApi = async () => {
    try {
      const response = await fetch(
        `https://api.themoviedb.org/3/tv/${id}/similar?api_key=4e7783a6a3bf804ec4011f13935e14b8`
      );
  ...
  return (
    <>
      <View className="flex-row items-center px-4 mt-4 mb-2">
        ...
        <Text className="text-xl font-bold text-gray-800 ml-2">Similar Series</Text>
      </View>
      {loading ? (
